/obj/structure/lattice/catwalk/ship
	name = "plated catwalk"
...
//Catwalk that goes OVER underfloor elements.
/obj/structure/lattice/catwalk/ship/over
	layer = CATWALK_LAYER

/obj/structure/lattice/catwalk/ship/dark
 	color = "#4c535b" //Curse you baystation

/obj/structure/lattice/catwalk/ship/crowbar_act(mob/living/user, obj/item/I)
